...
def get_superstore_data():
    '''
    This function reads in superstore data from Kaggle database, writes data to
    a csv file if a local file does not exist, and returns a df.
    '''
    if os.path.isfile('SampleSuperstore.csv'):
        ...
        print('Please download the file from https://www.kaggle.com/itssuru/super-store first and then try running this function again.')
